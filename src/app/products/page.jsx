    ...
    <div className="max-w-7xl mx-auto p-6 my-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {products.map((product) => (
          <div key={product._id} className="border rounded-xl shadow-md p-4 hover:shadow-lg flex flex-col">
            ...
            <Link href={`/products/${product._id}`} className="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded mt-auto text-center">View Details</Link>
          </div>
        ))}
      </div>
    </div>
