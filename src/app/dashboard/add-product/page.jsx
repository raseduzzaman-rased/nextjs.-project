  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <input type="text" name="price" placeholder="Price" value={product.price} onChange={handleChange} className="w-full px-4 py-2 border rounded" required />
        ...
        <button type="submit" disabled={loading} className="bg-teal-600 hover:bg-teal-700 text-white px-6 py-2 rounded">{loading ? "Adding..." : "Add Product"}</button>
      </form>
    </div>
  );
}
